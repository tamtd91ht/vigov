...
export const budgetItems: BudgetItem[] = [
  {
    ...
    approvalStatus: "da-duyet" as const,
    entries: [
      {
        date: "12/03/2026",
    ...
    requests: [
      ...
      {
        code: "DN-02",
        amountDong: 1_200_000_000,
        content: "Thanh toán khối lượng hoàn thành đợt 2",
        vendor: "Công ty TNHH Xây dựng Phú Thành",
        status: "disbursed",
        requestedBy: "Vũ Đức Anh",
        requestedAt: "14:02 05/07/2026",
        decidedBy: "Nguyễn Văn Bình",
        decidedAt: "08:30 07/07/2026",
        rejectReason: "",
        voucherNo: "UNC 214/2026",
        disbursedAt: "12/07/2026",
      },
    ],
  },
  {
    ...
    requests: [
      ...
      },
      {
        ...
        rejectReason: "Hồ sơ điều chỉnh thiết kế chưa được thẩm định. Bổ sung kết quả thẩm định rồi trình lại.",
        voucherNo: "",
        disbursedAt: "",
      },
    ],
