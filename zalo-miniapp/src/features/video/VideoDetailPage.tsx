...
import { contentService, hostedVideoUrl, youtubeId } from "@/services/content.service";
...
const BROKEN_YOUTUBE = "Link YouTube không hợp lệ. Cán bộ kiểm tra lại ở Web Quản trị → Nội dung Mobile → Video.";
      ...
      <div className="vplayer">
        ...
        {!video && (
          <span
            ...
            style={{ background: videoGradient(NEUTRAL_COVER), opacity: 0.42 }}
          />
        )}
